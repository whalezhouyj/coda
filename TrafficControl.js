...
(function() {
  ...
  var TrafficControl =
    ...
    (BMapLib.TrafficControl = function(options) {
      ...
      this.tcBtnId = options.tcBtnId || 'tcBtn';
    });
  // 继承Control
  ...
  TrafficControl.prototype._popUpDiv = function(me, btn) {
    ...
    //将用到的dom元素都存到变量中
    var viewPreDom = baidu.g(me.tcBtnId + 'tcViewPrediction');
    var dvPredition = baidu.g(me.tcBtnId + 'tcPredition');
    var dvTcTitle = baidu.g(me.tcBtnId + 'tcTitle');
    var dvTcDay = baidu.g(me.tcBtnId + 'maplibTcDay');
    var dvTcNow = baidu.g(me.tcBtnId + 'tcNow');
    var dvTcWrap = baidu.g(me.tcBtnId + 'tcWrap');
    var dvTcTimeBox = baidu.g(me.tcBtnId + 'tcTimeBox');
    var dvTcUpdate = baidu.g(me.tcBtnId + 'tcUpdate');
    ...
    this.hide = function() {
      ...
      if (baidu.isMobile()) {
        baidu.dom.addClass(me.tcBtnId + 'tcWrap_mobile', 'maplibTfctrHide');
      } else {
        baidu.dom.addClass(me.tcBtnId + 'tcWrap', 'maplibTcHide');
        baidu.dom.addClass(me.tcBtnId + 'tcPredition', 'maplibTcHide');
      }
      me.hideTraffic();
    };
    /**
    ...
    baidu.event.on(me.tcBtnId + 'tcClose', 'click', function(e) {
      showOrHidePopDiv();
    });
    ...
    function initialize() {
      ...
      if (baidu.isMobile()) {
        if (me.showPanel) {
          baidu.dom.removeClass(me.tcBtnId + 'tcWrap_mobile', 'maplibTfctrHide');
        }
      } else {
        baidu.dom.removeClass(me.tcBtnId + 'tcWrap', 'maplibTcHide');
      }

      //初始化a的状态
      var arrA = baidu.g(me.tcBtnId + 'tcWeek').getElementsByTagName('a');
      for (var i = 0; i < 7; i++) {
        arrA[i].className = '';
      }
    ...
    function genHtml_mobile() {
      return (
        '<div class="maplibTfctr maplibTfctrHide" id="' +
        me.tcBtnId +
        'tcWrap_mobile" style="position: absolute; z-index: 10; -webkit-text-size-adjust: none; bottom: 17px; right: auto; top: auto; left:50%;margin-left:-4.5em;"><div class="maplibTfctr_l"></div><div class="maplibTfctr_c">实时路况</div><div class="maplibTfctr_status"><span class="maplibR">堵</span><span class="maplibY">缓</span><span class="maplibG">畅</span></div></div>'
      );
    }

    //生成弹出div中的html
    function genHtml() {
      var html = ['<div class="maplibTc maplibTcHide" id="' + me.tcBtnId + 'tcWrap">'];
      html.push('<div class="maplibTcColor" id="' + me.tcBtnId + 'tcTitle">实时路况</div>');
      html.push('<div id="' + me.tcBtnId + 'tcRealTime">');
      html.push(
        '<div class="maplibTcTime"><span id="' +
          me.tcBtnId +
          'maplibTcDay" class="maplibTcCurTime">更新时间</span><span><span class="maplibTcColon">：&nbsp;</span><span class="maplibTcCurTime" id="' +
          me.tcBtnId +
          'tcNow"></span><span title="更新" id="' +
          me.tcBtnId +
          'tcUpdate" class="maplibTcUpdate"></span> <a href="javascript:void(0)" class="maplibTcView" id="' +
          me.tcBtnId +
          'tcViewPrediction">查看流量预测</a><button class="maplibTcClose" id="' +
          me.tcBtnId +
          'tcClose"></button></div></div>'
      );
      html.push('<div id="' + me.tcBtnId + 'tcPredition" class="maplibTcHide">');
      html.push(
        '<div class="maplibTcWeekDay"><span>星期</span><ul id="' +
          me.tcBtnId +
          'tcWeek"><li><a lang="1" href="javascript:void(0)">一</a></li><li><a lang="2" href="javascript:void(0)">二</a></li><li><a lang="3" href="javascript:void(0)">三</a></li><li><a lang="4" href="javascript:void(0)">四</a></li><li><a lang="5" href="javascript:void(0)">五</a></li><li><a lang="6" href="javascript:void(0)">六</a></li><li><a lang="7" href="javascript:void(0)">日</a></li></ul></div>'
      );
      html.push('<div><div class="maplibTcRuleTxt">时间</div>');
      html.push('<div class="maplibTcRule">');
      html.push(
        '<div><div class="maplibTcTimeBox" id="' + me.tcBtnId + 'tcTimeBox">20:00</div></div>'
      );
      html.push('<div class="maplibTcTimeline" >');
      html.push('<div class="maplibTcTimelinePrev" id="' + me.tcBtnId + 'tcPrev"></div>');
      html.push('<div class="maplibTcTimeMove" id="' + me.tcBtnId + 'tcMove"></div>');
      html.push('<div class="maplibTcTimelineNext" id="' + me.tcBtnId + 'tcNext"></div>');
    ...
    function bindEventToPopDiv(me) {
      baidu.event.on(me.tcBtnId + 'tcViewPrediction', 'click', function() {
      ...
      baidu.event.on(me.tcBtnId + 'tcUpdate', 'click', function() {
        initialize();
      });
    }
    ...
    function bindEventToWeek(me) {
      baidu.event.on(me.tcBtnId + 'tcWeek', 'onclick', function(e) {
    ...
    function setBar(me) {
      var hour;
      var bt = baidu.g(me.tcBtnId + 'tcMove');
      ...
      function dragIng(e) {
        var x = e.clientX || e.x;
        var left = getPosition(baidu.G(me.tcBtnId + 'tcPrev')).left + 9;
        var margin = x - left - 4;
      ...
      //绑定时间条中向前的箭头
      baidu.on(me.tcBtnId + 'tcPrev', 'click', function() {
        setBarBtn('prev');
      });
      //绑定时间条中向后的箭头
      baidu.on(me.tcBtnId + 'tcNext', 'click', function() {
        setBarBtn('next');
      });
      ...
      function setBarBtn(key) {
        var box = dvTcTimeBox;
        var margin = parseInt(baidu.dom.getStyle(me.tcBtnId + 'tcTimeBox', 'marginLeft'));
  ...
  TrafficControl.prototype.remove = function() {
    this.hideTraffic();
    var dvWrap = baidu.g(me.tcBtnId + 'tcWrap');
    //移除在dom中添加的html
